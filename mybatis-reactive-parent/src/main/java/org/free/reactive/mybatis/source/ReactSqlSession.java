...
public interface ReactSqlSession extends Closeable {
     ...
     */
    <E> Mono<List<E>> selectList(String statement);
     ...
     * @return List of mapped object
     */
    <E> Mono<List<E>> selectList(String statement, Object parameter);
     ...
     * @return List of mapped object
     */
    <E> Mono<List<E>> selectList(String statement, Object parameter, RowBounds rowBounds);
     ...
     * @since 3.0.6
     */
    Mono<List<BatchResult>> flushStatements();
